...
public class DescriptionUI : MonoBehaviour
{
    ...
    public void SetTextInfo(int num)
    {
        ...
        switch(num)
        {
            ...
            case 5:
                descriptionText.text = "모든 공격력의 합산이 끝난후 곱해지는 공격력 배율값과 관련된 능력치. 각 캐릭터마다 다른 배율을 가진다.";
                break;

            case 6:
                descriptionText.text = "검, 총류 무기의 공격력와 관련된 능력치. 이 수치가 몬스터의 방어력 보다 낮으면 대미지가 들어가지 않는다.";
                break;

            case 7:
                descriptionText.text = "스태프류 무기의 공격력와 관련된 능력치. 이 수치가 몬스터의 방어력 보다 낮으면 대미지가 들어가지 않는다.";
                break;

            case 8:
                descriptionText.text = "총, 스태프류 무기의 공격력와 관련된 능력치. 이 수치가 몬스터의 방어력 보다 낮으면 대미지가 들어가지 않는다.";
                break;

            case 9:
                descriptionText.text = "검류 무기의 공격력와 관련된 능력치. 이 수치가 몬스터의 방어력 보다 낮으면 대미지가 들어가지 않는다.";
                break;
